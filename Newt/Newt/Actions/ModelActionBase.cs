...
namespace Newt.Actions
{
    ...
    {
        /// <summary>
        /// Private member variable for Document
        /// </summary>
        ...
        {
            //TODO: Reinstate
            //if (exInfo != null) Document.History.CleanIteration(exInfo);
            return true;
        }
        ...
        {
            //TODO: Reinstate
            //if (exInfo != null) Document.History.CleanSubsequentIterations(exInfo);
            return true;
        }
    }
}
